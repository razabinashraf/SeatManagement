    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CabinRooms", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OpenRoomsSeatMaps", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AllocatedAssets", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AllocatedAssets_Assets_AssetId",
                        column: x => x.AssetId,
                        principalTable: "Assets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AllocatedAssets_MeetingRooms_MeetingRoomId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AllocatedAssets_AssetId",
                table: "AllocatedAssets",
                column: "AssetId");

            migrationBuilder.CreateIndex(
                name: "IX_AllocatedAssets_MeetingRoomId",
                table: "AllocatedAssets",
